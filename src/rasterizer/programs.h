...
struct Lambertian {
	...
	enum {
		VA_PositionX, VA_PositionY, VA_PositionZ,
		VA_NormalX, VA_NormalY, VA_NormalZ,
		VA_TexCoordU, VA_TexCoordV,
		VA
	};
	//fragment attribute layout:
	enum {
		FA_TexCoordU, FA_TexCoordV,
		FA_NormalX, FA_NormalY, FA_NormalZ,
		FA
	};
	...
	static void shade_vertex(
		...
		fa[FA_TexCoordU] = fa_texcoord.x; fa[FA_TexCoordV] = fa_texcoord.y;
		fa[FA_NormalX] = fa_normal.x; fa[FA_NormalY] = fa_normal.y; fa[FA_NormalZ] = fa_normal.z;
	}
